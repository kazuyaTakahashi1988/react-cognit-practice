...
import AccordionExample from "./accordionExample/page";
import DropdownMenuExample from "./dropdownMenuExample/page";
import FormExample from "./formExample/page";
import ModalExample from "./modalExample/page";
import StoreExample from "./storeExample/page";
import TodoExample from "./todoExample/page";
...
vi.mock("../../utils/apiHelper", () => ({ testPostApi: apiMocks.post }));
